...
export const NORDIC_DFU_CONTROL_CHAR = '8ec90001-f315-4f60-9fb8-838830daea50';

/** Nordic DFU packet characteristic UUID. */
export const NORDIC_DFU_PACKET_CHAR = '8ec90002-f315-4f60-9fb8-838830daea50';

/** Nordic buttonless DFU characteristic UUID (write 0x01 to reboot to bootloader). */
export const NORDIC_DFU_BUTTONLESS_CHAR = '8ec90003-f315-4f60-9fb8-838830daea50';
